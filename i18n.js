...
const REVIEW_SEEN_KEY = 'freedom_review_seen';
const GOOGLE_REVIEW_URL = 'https://share.google/CZt6j6ZvCqkixWMhP';
...
const dict = {
  ar: {
    ...
    review_toast_title: 'استمتعت بوقتك؟',
    review_toast_text: 'كلمة صغيرة منك على جوجل تسعدنا كثيراً.',
    review_cta: 'قيّم تجربتك',
    review_later: 'ربما لاحقاً',
    review_close: 'إغلاق',
    footer_review_eyebrow: 'رأيك يهمنا',
    footer_review_title: 'شاركنا تجربتك',
    footer_review_text: 'تقييمك على جوجل يستغرق دقيقة واحدة، ويساعدنا كثيراً في الاستمرار على تقديم الأفضل.',
    footer_review_cta: 'قيّمنا على جوجل',
    review_fab_label: 'قيّمنا',
  },
  en: {
    brand_name: 'Freedom',
    ...
    review_toast_title: 'Enjoying your evening?',
    review_toast_text: "A quick word from you on Google would mean a lot to us.",
    review_cta: 'Leave a review',
    review_later: 'Maybe later',
    review_close: 'Close',
    footer_review_eyebrow: 'We\u2019d love your feedback',
    footer_review_title: 'Tell us how it went',
    footer_review_text: 'A review takes less than a minute and genuinely helps us keep getting better.',
    footer_review_cta: 'Rate us on Google',
    review_fab_label: 'Rate us',
  },
  fr: {
    brand_name: 'Freedom',
    brand_tag: 'Lounge, Bar & Restaurant',
    ...
    review_toast_title: 'Vous passez un bon moment ?',
    review_toast_text: 'Un petit mot de votre part sur Google nous ferait vraiment plaisir.',
    review_cta: 'Laisser un avis',
    review_later: 'Plus tard',
    review_close: 'Fermer',
    footer_review_eyebrow: 'Votre avis compte',
    footer_review_title: 'Racontez-nous votre visite',
    footer_review_text: 'Un avis prend moins d\u2019une minute et nous aide vraiment à nous améliorer.',
    footer_review_cta: 'Nous noter sur Google',
    review_fab_label: 'Nous noter',
  },
  ru: {
    brand_name: 'Freedom',
    ...
    review_toast_title: 'Хорошо проводите время?',
    review_toast_text: 'Пара слов от вас на Google очень много для нас значит.',
    review_cta: 'Оставить отзыв',
    review_later: 'Позже',
    review_close: 'Закрыть',
    footer_review_eyebrow: 'Нам важно ваше мнение',
    footer_review_title: 'Расскажите о своём визите',
    footer_review_text: 'Отзыв займёт меньше минуты и правда помогает нам становиться лучше.',
    footer_review_cta: 'Оценить нас на Google',
    review_fab_label: 'Оценить',
  },
  es: {
    brand_name: 'Freedom',
    ...
    review_toast_title: '¿Lo estás pasando bien?',
    review_toast_text: 'Unas palabras tuyas en Google significarían mucho para nosotros.',
    review_cta: 'Dejar una reseña',
    review_later: 'Más tarde',
    review_close: 'Cerrar',
    footer_review_eyebrow: 'Tu opinión nos importa',
    footer_review_title: 'Cuéntanos qué tal fue',
    footer_review_text: 'Una reseña te lleva menos de un minuto y realmente nos ayuda a mejorar.',
    footer_review_cta: 'Califícanos en Google',
    review_fab_label: 'Califícanos',
  },
  pl: {
    brand_name: 'Freedom',
    ...
    review_toast_title: 'Miło spędzacie czas?',
    review_toast_text: 'Kilka słów od Was na Google naprawdę wiele dla nas znaczy.',
    review_cta: 'Zostaw opinię',
    review_later: 'Może później',
    review_close: 'Zamknij',
    footer_review_eyebrow: 'Zależy nam na opinii',
    footer_review_title: 'Podziel się swoją wizytą',
    footer_review_text: 'Opinia zajmuje mniej niż minutę i naprawdę pomaga nam się rozwijać.',
    footer_review_cta: 'Oceń nas na Google',
    review_fab_label: 'Oceń nas',
  },
  de: {
    brand_name: 'Freedom',
    brand_tag: 'Lounge, Bar & Restaurant',
    ...
    review_toast_title: 'Gefällt es Ihnen bei uns?',
    review_toast_text: 'Ein paar Worte von Ihnen auf Google würden uns sehr freuen.',
    review_cta: 'Bewertung schreiben',
    review_later: 'Vielleicht später',
    review_close: 'Schließen',
    footer_review_eyebrow: 'Ihre Meinung zählt',
    footer_review_title: 'Erzählen Sie uns von Ihrem Besuch',
    footer_review_text: 'Eine Bewertung dauert weniger als eine Minute und hilft uns wirklich weiter.',
    footer_review_cta: 'Auf Google bewerten',
    review_fab_label: 'Bewerten',
  },
  it: {
    brand_name: 'Freedom',
    ...
    review_toast_title: 'Vi state trovando bene?',
    review_toast_text: 'Due parole da parte vostra su Google significherebbero molto per noi.',
    review_cta: 'Lascia una recensione',
    review_later: 'Magari più tardi',
    review_close: 'Chiudi',
    footer_review_eyebrow: 'La vostra opinione conta',
    footer_review_title: 'Raccontateci la vostra visita',
    footer_review_text: 'Una recensione richiede meno di un minuto e ci aiuta davvero a migliorare.',
    footer_review_cta: 'Valutateci su Google',
    review_fab_label: 'Valutateci',
  },
};
...
const CATEGORY_HINTS = {
  ...
  soup:            {ar:'تُقدم جميع أنواع الشوربة مع خبز منزلي.', en:'All soups served with homemade bread.', fr:'Toutes les soupes sont servies avec du pain maison.', ru:'Все супы подаются с домашним хлебом.', es:'Todas las sopas se sirven con pan casero.', pl:'Wszystkie zupy podawane są z domowym chlebem.', de:'Alle Suppen werden mit hausgemachtem Brot serviert.', it:'Tutte le zuppe sono servite con pane fatto in casa.'},
  sandwiches:      {ar:'جميع الساندويتشات تُقدم مع البطاطس المقلية.', en:'All sandwiches served with fries.', fr:'Tous les sandwiches sont servis avec des frites.', ru:'Все сэндвичи подаются с картофелем фри.', es:'Todos los sándwiches se sirven con papas fritas.', pl:'Wszystkie kanapki podawane są z frytkami.', de:'Alle Sandwiches werden mit Pommes serviert.', it:'Tutti i panini sono serviti con patatine fritte.'},
  main_dishes:     {ar:'جميع الأطباق تُقدم مع (أرز أو بطاطس مقلية أو خضار سوتيه) + صوص من اختيارك.', en:'All dishes are served with rice, fries, or sautéed vegetables, plus your choice of sauce.', fr:"Tous les plats sont servis avec du riz, des frites ou des légumes sautés, accompagnés d'une sauce au choix.", ru:'Все блюда подаются с рисом, картофелем фри или овощами соте, плюс соус на выбор.', es:'Todos los platos se sirven con arroz, papas fritas o verduras salteadas, más una salsa a elección.', pl:'Wszystkie dania podawane są z ryżem, frytkami lub warzywami saute, plus sos do wyboru.', de:'Alle Gerichte werden mit Reis, Pommes oder sautiertem Gemüse sowie einer Sauce nach Wahl serviert.', it:'Tutti i piatti sono serviti con riso, patatine o verdure saltate, più una salsa a scelta.'},
  ...
  shisha:          {ar:'اختر نكهتك المفضلة: تفاح، خوخ، ليمون، مانجو، عنب، نعناع، فراولة، بطيخ، توت أزرق.', en:'Choose your favorite flavor: Apple, Peach, Lemon, Mango, Grapes, Mint, Strawberry, Watermelon, Blueberry.', fr:'Choisissez votre saveur préférée : pomme, pêche, citron, mangue, raisin, menthe, fraise, pastèque, myrtille.', ru:'Выберите любимый вкус: яблоко, персик, лимон, манго, виноград, мята, клубника, арбуз, черника.', es:'Elige tu sabor favorito: manzana, durazno, limón, mango, uva, menta, fresa, sandía, arándano.', pl:'Wybierz swój ulubiony smak: jabłko, brzoskwinia, cytryna, mango, winogrona, mięta, truskawka, arbuz, jagoda.', de:'Wähle dein Lieblingsaroma: Apfel, Pfirsich, Zitrone, Mango, Traube, Minze, Erdbeere, Wassermelone, Blaubeere.', it:'Scegli il tuo gusto preferito: mela, pesca, limone, mango, uva, menta, fragola, anguria, mirtillo.'},
...
window.CafeI18n = {
  ...
  GOOGLE_REVIEW_URL, REVIEW_SEEN_KEY,
};
